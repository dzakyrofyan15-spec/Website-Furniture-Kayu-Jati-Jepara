...
<body>
    ...
    <main class="form-container">
        ...
        <?php echo form_open_multipart('administrator/edit/' . $product['id_produk']); ?>
            
            <div class="form-group">
                <label for="nama_produk">Nama Produk:</label>
                <input type="text" id="nama_produk" name="nama_produk" required 
                       value="<?php echo set_value('nama_produk', $product['nama_produk']); ?>">
            </div>
            ...
            <div class="form-group">
                <label for="gambar_utama">Ganti Gambar Utama (Opsional, Maks 5MB):</label>
